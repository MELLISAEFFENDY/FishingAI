...
local function performTestJump()
    ...
    if rootPart then
        ...
        print("✅ Character velocity:", rootPart.Velocity)
    end
    ...
    -- Multiple jump methods for better compatibility
    print("🦘 Executing jump...")
    
    -- Method 1: Direct jump
    humanoid.Jump = true
    
    -- Method 2: Force jump with small delay
    task.wait(0.1)
    humanoid.Jump = true
    
    -- Method 3: Alternative jump using ChangeState (backup)
    task.spawn(function()
        task.wait(0.2)
        pcall(function()
    ...
    print("✅ Jump commands sent (multiple methods)")
